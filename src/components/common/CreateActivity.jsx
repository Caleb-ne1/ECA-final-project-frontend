...
const CreateActivity = () => {
  ...
  const createActivity = async (e) => {
    ...
    try {
      ...
      setImageLink(""), setActivityDescription(""), setActivityType("");
      setEligibility(""), setmaxparticipants(""), setRegistrationDeadline("");
  ...
  return (
    <div className="pt-16 pl-5 pr-5 s create_activity_cont">
      <h4 className="p-4 mt-2 mb-2 bg-gray-50">Create activity</h4>
        ...
        <div className="p-4">
          ...
          {sections.isExpanded && (
            <div className="mt-4 space-y-6">
              ...
              <div className="space-y-4 group sm:flex-row sm:items-center sm:space-x-4">
                <label
                  htmlFor="registration_dateline"
                ...
                <div className="flex flex-col w-full sm:flex-row sm:space-x-4">
                  ...
                  <div className="flex flex-col w-full sm:w-auto">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    />
                  </div>
            ...
            <div className="mt-4 space-y-6">
              ...
              <div className="group">
                ...
                <div className="mt-2">
                  ...
                  <div className="flex flex-col mt-4 space-y-4 sm:space-y-0 sm:flex-row sm:space-x-4">
                    {/* End Date */}
                    <div className="flex flex-col w-full sm:w-1/2">
                      <label
                        htmlFor="end_date"
