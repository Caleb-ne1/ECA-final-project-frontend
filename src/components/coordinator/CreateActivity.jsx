    ...
    <div className="pt-16 pl-10 pr-10 create_activity_cont">
      ...
      <form className="flex flex-col gap-2">
        ...
        <div className="flex space-x-4 justify-center mb-10">
          ...
          <button className=" gap-2 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 flex items-center">
            <RiDraftFill className="h-24" />
            Save to Draft
          </button>
