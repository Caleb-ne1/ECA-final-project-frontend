...
const ActivitiesChart = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_APP_API_URL}/api/count/user-created-activities-per-month`, {withCredentials: true}) 
      .then((response) => {
  ...
  return (
    <div className="p-4 bg-white">
      <h2 className="mb-3 text-lg font-bold">Your Monthly Activity Creation Trend</h2>
