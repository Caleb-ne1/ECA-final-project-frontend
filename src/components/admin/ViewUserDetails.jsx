...
function ViewUserDetails() {
  ...
  // handle view user login history
  const ViewUserLoginHistory = (id) => {
    window.location.href = `/view-login-history?id=${encodeURIComponent(id)}`;
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6 mt-16">
      <div className="w-full max-w-3xl overflow-hidden">
        ...
        <a onClick={() => ViewUserLoginHistory(user.id)} className="flex flex-row items-center gap-2 font-bold text-blue-900 hover:cursor-pointer hover:underline"><MdOutlineHistory size={25} />view user Login history</a>
        {/* Edit Button */}
