  ...
  return (
    <div className="pt-16">
      <div className="max-w-2xl p-6 mx-auto rounded-md">
        <button
          className="flex items-center mb-2 px-2 py-2 text-sm font-medium text-blue-600 rounded-lg shadow focus:outline-none"
        ...
        <form onSubmit={handleEditUser}>
          ...
          <p className="font-bold mb-1">Academic Information</p>

          {/* institution_id and program_of_study */}
          <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
            <div>
              <label
