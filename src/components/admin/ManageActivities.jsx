    ...
    <div className="min-h-screen p-6 mt-16 bg-white">
      <div className="flex items-center justify-between mb-6">
        ...
        >
          ...
          <span className="text-lg">Add New Activity</span>
        </a>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {paginatedActivities.map((activity) => (
          <div
            key={activity.id}
            className="overflow-hidden transition bg-white shadow-md hover:shadow-lg"
          >
            <img
      ...
      {filteredActivities.length === 0 && (
        <p className="mt-6 text-center text-gray-500">No activities found</p>
      )}
