...
import RegisteredActivities from './components/common/RegisteredActivities';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white App">
      ...
      <Routes>
        ...
        <Route path="/my" element={<CoordinatorDashboard />} />
        <Route path="/admin-dashboard" element={<AdminDashboard />} />
        <Route path="/home" element={<Home />} />
        <Route path="/user/profile" element={<Profile />} />
        <Route path="/manage_users" element={<ManageUser />} />
        <Route path="/view-login-history" element={<LoginHistory />} />
        <Route
        ...
        <Route path ="/created activities" element = {<MyActivities />} />
        ...
        />
        <Route path='/enrolled activities' element={<RegisteredActivities />} />
